...
class MemberCardDetailAdapter(private val context : Context, private val memberList : ArrayList<Users> ):
    RecyclerView.Adapter<MemberCardDetailAdapter.MemberViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MemberViewHolder {
        return MemberViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.card_detail_members, parent, false)
        )
    }
